...
<div style={{
  ...
  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, paddingLeft: 40, justifyContent: 'center' }}>
    ...
    <div style={{ display: 'flex', marginTop: 28, fontSize: 12, letterSpacing: 4, color: '#ffb547', textTransform: 'uppercase' }}>
  ...
  <div style={{ display: 'flex', flex: 1, marginTop: 28, gap: 14 }}>
    {[
      ...
      <div key={i} style={{
        ...
        background: '#111', borderTop: '3px solid #ffb547',
      }}>
        <div style={{ display: 'flex', fontSize: 11, letterSpacing: 3, color: '#a89580', fontWeight: 700 }}>{c.i}</div>
        <div style={{ display: 'flex', fontSize: 32, fontWeight: 900, marginTop: 10, color: '#ffb547', letterSpacing: -1 }}>{c.s}</div>
